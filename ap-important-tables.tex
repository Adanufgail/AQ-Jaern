...
\begin{normbox}[Blunt Critical Wounds]\input{table-critical-hits-blunt.tex}\end{normbox}

\subsection{Bludgeon Weapon Critical Wounds}
\label{critical-hits-bludgeon}
\begin{normbox}[Bludgeon Critical Wounds]\input{table-critical-hits-bludgeon.tex}\end{normbox}

\section{Spell Overloading}
\input{table-overload.tex}
\input{table-multiple-dice-success.tex}
\section{Ship Combat}
\begin{multicols}{2}

...
\item Chapter and page number references are \textbf{bold} and highlighted in a \custhl[soulCrimson]{light salmon}  and written in a "Ch \#: Title" format for chapters and a "Page \#"" format for pages.
	...
	\begin{itemize}\item Example: Aging is covered in detail in \chpage{ch:jaern-humanoids}.\end{itemize}
...
\item Measurements of distance, length, weight, temperature, and time are bold and highlighted in \custhl[soulKhaki]{light tan}  a and wrtiten in a "number unit" format. Measurements part of a definition will be highlighted in the definition color.
...
\item Listings are headings that are then described in detail in the following paragraph, and are \textbf{bold} and highlighted in a \custhl[soulGrey]{grey}.
	\begin{itemize}\item Example: \listing{Area: caster}\\
	This limits the spell effect to the caster.\end{itemize}
\item Names of elemental spells are \textbf{bold} and highlighted in a \custhl[soulRed]{red}.
	\begin{itemize}\item Example: \espell{Defer}\end{itemize}
\item Names of divine spells are \textbf{bold} and highlighted in a \custhl[soulYellow]{yellow}.
	\begin{itemize}\item Example: \dspell{Defer}\end{itemize}
\item Names of nomad spells are \textbf{bold} and highlighted in a \custhl[soulTurquoise]{turquoise}.
	\begin{itemize}\item Example: \nspell{Defer}\end{itemize}
\item Names of skills are \textbf{bold} and highlighted in a \custhl[soulLavender]{lavender}.
	\begin{itemize}\item Example: \skill{Defer}\end{itemize}

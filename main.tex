...
\newcommand{\result}[1]{\tcresult{#1}}
\newcommand{\measure}[1]{\tcmeasure{#1}}
\newcommand{\mets}[4]{%
  \ifthenelse{\equal{#2}{}}{%
...
\colorlet{soulDodgerBlue}{white!40!DodgerBlue}
\colorlet{soulCrimson}{white!40!Crimson}
...
\DeclareRobustCommand{\tcmeasure}[1]{\sethlcolor{soulKhaki}\textbf{\hl{\mbox{#1}}}\xspace}
\DeclareRobustCommand{\tcresult}[1]{\sethlcolor{soulCyan}\textbf{\hl{\mbox{#1}}}\xspace}

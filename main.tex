...
%\include{test.tex}
%\begin{comment}
\include{beg-titlepage.tex}
\include{beg-copyright.tex}
\include{beg-dedication.tex}
\include{beg-introduction.tex}
\tableofcontents
\include{beg-changes.tex}
\include{ch-creating-an-adventurer.tex}
\include{ch-playing-an-adventurer.tex}
\include{ch-life-on-the-high-seas.tex}
\include{ch-skills.tex}
...
\include{ch-marines.tex}
\include{ch-auger.tex}
\include{ch-nomad.tex}
\include{ch-elem-core.tex}

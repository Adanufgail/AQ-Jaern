...
\newtcolorbox{normboxlist}[1][]{ boxrule=0pt, enhanced, title=\small\textbf{#1}, left=1pt, right=1pt, top=0pt, bottom=-2pt, boxsep=2pt, boxrule=0.6pt, before skip=0.0pt, after skip=0.0pt, lefttitle=2pt, righttitle=2mm, toptitle=1mm, bottomtitle=0mm, minipage boxed title, colbacktitle=Navy, colback=white}
...
\include{beg-introduction.tex} 
\tableofcontents
\label{ch:changes} \include{beg-changes.tex} 
\include{ch-create-creating-an-adventurer.tex} 
\begin{comment}
\include{ch-create-jaernian-humanoids.tex}
\include{ch-play-life-on-the-high-seas.tex} 
\include{ch-play-playing-an-adventurer.tex}
\include{ch-play-physical-combat.tex}
\include{ch-play-casting-magic.tex}
\include{ch-play-skills.tex} 
\include{ch-class-marines.tex} 
\include{ch-class-auger.tex} 
\include{ch-class-nomad.tex} 
\include{ch-magic-elem-core.tex} 
\include{ch-magic-elem-earth.tex} 
\include{ch-magic-elem-fire.tex} 
\include{ch-magic-elem-air.tex} 
\include{ch-magic-elem-water.tex} 
\include{ch-magic-divine-core.tex}
\include{ch-magic-divine-anubis.tex}
\include{ch-magic-divine-atena.tex}
\include{ch-magic-divine-isis.tex}
\include{ch-magic-divine-neptune.tex}
\include{ch-magic-divine-osus.tex}
\include{ch-magic-divine-osiris.tex}
\include{ch-magic-divine-ra.tex}
\include{ch-magic-divine-rudri.tex}
\include{ch-magic-divine-scrogg.tex}
\include{ch-magic-divine-tarus.tex}
\include{ch-magic-divine-tor.tex}
\include{ch-magic-creating-magical-items.tex}
\include{ch-world-magical-items.tex}
\include{ch-world-onivero.tex}
\include{ch-world-jaern-planet.tex}
\include{ch-world-lojem-isle.tex}
\include{ch-world-rougtero.tex}
\include{ch-world-actors-rougtero.tex}
\include{ch-world-creatures.tex}
\include{ch-gm-creating-and-playing-actors.tex}
\include{ch-gm-creating-creatures.tex}
\include{ch-gm-creating-adventures.tex}
\include{ch-gm-judging-adventures.tex}
\addtocontents{toc}{\protect\renewcommand{\protect\cftchappresnum}{Appendix }}
\include{ch-gm-running-campaign.tex}
\appendix
\include{ap-charsheet.tex} 

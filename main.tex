...
\label{ch:beg-changes} \include{beg-changes.tex} 
\tableofcontents
\label{ch:beg-how-to-read}\include{beg-how-to-read.tex} 
\label{ch:create-creating-an-adventurer}\include{ch-create-creating-an-adventurer.tex} 
\include{ch-create-jaernian-humanoids.tex} %transcribed
...
\include{ch-play-skills.tex} %transcribed
\include{ch-class-marines.tex} %transcribed 
\include{ch-class-auger.tex} %transcribed
\include{ch-class-nomad.tex} %transcribed
\include{ch-magic-elem-core.tex} %transcribed
\include{ch-magic-elem-earth.tex} %transcribed
\include{ch-magic-elem-fire.tex} %transcribed
\include{ch-magic-elem-air.tex} %transcribed
\include{ch-magic-elem-water.tex} %transcribed
\include{ch-magic-divine-core.tex} %transcribed
...
\include{ch-magic-divine-orus.tex}

...
\DeclareRobustCommand{\secref}[1]{\custhl[soulCrimson]{\textbf{\nameref{#1}}}}
...
\DeclareRobustCommand{\incantentry}[7]{%
  \begin{tabularx}{\linewidth}{@{} p{5pt} p{100pt} p{60pt} X}%
    ...
    \begin{tabular}[t]{@{}rl}
      ...
      Silver: & #4\\
      Time to Make: & #5\\
      \makecell[tl]{Ingredients:} & \makecell[lt]{\small #6}\\
    \end{tabular} & &
    \small #7\\
  \end{tabularx}\\
  \vspace{1pt}
...
\include{ch-physical-combat.tex}
\include{ch-casting-magic.tex}
...
\include{ch-elem-earth.tex} %done
\include{ch-elem-fire.tex} %done
\include{ch-elem-air.tex} %done
\include{ch-elem-water.tex} %done
